...
terraform {
  provider_meta "google" {
    ...
    module_name           = "anthos-samples/terraform/anthos-bm-terraform:gce/v>= 0.1.0"
    gcloud                = "terraform-google-modules/gcloud/google/v>= 2.1.0"
    gcp_apis              = "terraform-google-modules/project-factory/google//modules/project_services/v~> 10.3.2"
